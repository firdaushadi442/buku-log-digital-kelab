...
// Updated API URL
export const API_URL = "https://script.google.com/macros/s/AKfycbxBK2uvEwACKZ83Qrk9aFmhs0ZlVZEFsZIYE6uAkyn7AUzvwOfzMyp1dCoUh7cKcPKeUA/exec";
...
export const CLUBS_CONFIG: Record<string, { logo: string, flag: string, color: string, colorClass: string }> = {
  'Kelab Bahasa': {
    logo: 'https://cdn-icons-png.flaticon.com/512/3976/3976625.png', // Dummy
    flag: '',
    color: '#3B82F6', // Blue
    colorClass: 'blue'
  },
  'Kelab Kerjaya/KPJ': {
    logo: 'https://cdn-icons-png.flaticon.com/512/1063/1063376.png', // Dummy
    flag: '',
    color: '#F59E0B', // Amber
    colorClass: 'amber'
  },
  'Kelab STEM/Pengguna': {
    logo: 'https://cdn-icons-png.flaticon.com/512/2022/2022299.png', // Dummy
    flag: '',
    color: '#10B981', // Emerald/Green
    colorClass: 'emerald'
  },
  'Kelab Kebudayaan/ICT': {
    logo: 'https://cdn-icons-png.flaticon.com/512/3074/3074765.png', // Dummy
    flag: '',
    color: '#8B5CF6', // Violet
    colorClass: 'violet'
  }
