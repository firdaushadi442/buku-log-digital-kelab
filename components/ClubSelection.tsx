...
import { BookOpen, Briefcase, Microscope, Palette, ArrowRight } from 'lucide-react';
...
const clubs = [
    {
        ...
        icon: BookOpen,
        color: 'bg-blue-500',
        desc: 'Memartabatkan bahasa, memperkukuh budaya komunikasi.',
        gradient: 'from-blue-500 to-cyan-400'
    },
    {
        id: 'Kelab Kerjaya/KPJ',
        title: 'Kelab Kerjaya / KPJ',
        icon: Briefcase,
        color: 'bg-amber-500',
        desc: 'Meneroka peluang masa depan dan pembangunan kerjaya.',
        gradient: 'from-amber-500 to-orange-400'
    },
    {
        id: 'Kelab STEM/Pengguna',
        title: 'Kelab STEM / Pengguna',
        icon: Microscope,
        color: 'bg-emerald-500',
        desc: 'Sains, Teknologi, Kejuruteraan dan Matematik pemacu inovasi.',
        gradient: 'from-emerald-500 to-green-400'
    },
    {
        id: 'Kelab Kebudayaan/ICT',
        title: 'Kelab Kebudayaan / ICT',
        icon: Palette,
        color: 'bg-violet-500',
        desc: 'Melestarikan seni budaya seiring teknologi terkini.',
